...
public class BlockNiriteFurnace extends BlockContainer {
    ...
    public BlockNiriteFurnace() {
        super(Material.rock);
        this.powered = false;
        this.setCreativeTab(CreativeTabCommon.COMMON_TAB);
        this.setBlockName(Names.Blocks.NIRITE_FURNACE);
    }

    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
        return Item.getItemFromBlock(ModBlocks.furnaceNirite);
    }

    /**
     * Called whenever the block is added into the world. Args: world, x, y, z
     */
    public void onBlockAdded(World world1, int int2, int int3, int int4) {
        super.onBlockAdded(world1, int2, int3, int4);
        this.placedBlock(world1, int2, int3, int4);
    }

    private void placedBlock(World p_149930_1_, int p_149930_2_, int p_149930_3_, int p_149930_4_) {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        this.front = p_149651_1_.registerIcon(this.powered ? "furnace_front_on" : "furnace_front_off");
        this.topside = p_149651_1_.registerIcon("furnace_top");
    }

    /**
     * Called upon block activation (right click on the block.)
     */
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityPlayer, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        if (world.isRemote) {
            return true;
        } else {
        ...
        if (!field_149934_M) {
            ...
            if (tileentityfurnace != null) {
                for (int i1 = 0; i1 < tileentityfurnace.getSizeInventory(); ++i1) {
                    ...
                    if (itemstack != null) {
                        float f = this.randomint.nextFloat() * 0.8F + 0.1F;
                        float f1 = this.randomint.nextFloat() * 0.8F + 0.1F;
                        float f2 = this.randomint.nextFloat() * 0.8F + 0.1F;

                        while (itemstack.stackSize > 0) {
                            int j1 = this.randomint.nextInt(21) + 10;
                            ...
                            float f3 = 0.05F;
                            entityitem.motionX = (double) ((float) this.randomint.nextGaussian() * f3);
                            entityitem.motionY = (double) ((float) this.randomint.nextGaussian() * f3 + 0.2F);
                            entityitem.motionZ = (double) ((float) this.randomint.nextGaussian() * f3);
